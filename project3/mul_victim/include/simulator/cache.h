...
public:
  ...
  Cache(MemoryManager *manager, Policy policy, Cache *lowerCache = nullptr,  Cache *victim = nullptr,
...
private:
  ...
  Cache *lowerCache;
  Cache *victim; // victim cache pointer
  Policy policy;
  ...
  void moveBlockToVictimCache(Block &b); 
