...
int main(int argc, char **argv) {
  ...
  // exclusive
  l3cache = new Cache(memory, l3policy, nullptr, true, true);
  l2cache = new Cache(memory, l2policy,l3cache, true, true);
  l1cache = new Cache(memory, l1policy, l2cache, true, true);
